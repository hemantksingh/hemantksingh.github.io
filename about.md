...
Be it technology modernisation, Data and AI strategy, or just helping engineering teams to make better decisions, I believe in keeping things simple, delivering value quickly and creating environments where people feel supported and inspired.
  </div>
  <div class="about-hero-photo">
    <img src="{{ site.url }}/assets/hk-portrait.jpg" alt="Hemant Kumar at the summit of Snowdon" width="640" height="960" fetchpriority="high" decoding="async"/>
    <p class="about-photo-caption">At the summit of Snowdon, Wales</p>
  </div>
</div>
